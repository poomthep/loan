// Data layer (no modules). Depends on window.sb (supabase client)
(function(){
  ...
  // ---- Promotions ---- (ใช้คอลัมน์ y1,y2,y3 ตามที่คุณใช้อยู่)
  ...
  // expose globals
  window.DM = { getMyRole, getBanks, updateBankMRR, listPromotions, createPromotion, updatePromotion, upsertPromotion, deletePromotion };
})();
